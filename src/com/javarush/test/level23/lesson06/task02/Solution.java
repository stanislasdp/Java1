...
public class Solution {
    ...
    {
        final static String SERVER_IS_NOT_ACCESSIBLE_FOR_NOW = "Server is not accessible for now.";
        final static String USER_IS_NOT_AUTHORIZED = "User is not authorized.";
        final static String USER_IS_BANNED = "User is banned.";
